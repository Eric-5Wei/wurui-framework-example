...
public class MyBatisPlusGenerate {
	 ...
	 * 作者
	 */
	private static final String AUTHOR = "WuRui";
	 ...
	 * JDBC 连接地址
	 */
	private static final String JDBC_URL = "jdbc:mysql:///wurui?serverTimezone=Asia/Shanghai&useLegacyDatetimeCode=false&nullNamePatternMatchesAll=true&zeroDateTimeBehavior=CONVERT_TO_NULL&tinyInt1isBit=false&autoReconnect=true&useSSL=false&pinGlobalTxToPhysicalConnection=true";
	 ...
	 * 包配置 - 父级目录
	 */
	private static final String PACKAGE_PARENT = "com.wurui";
	 ...
	 * 通用包路径
	 */
	private static final String PACKAGE_BASE = "com.wurui.commons.base";
	...
	private static PackageConfig packageConfig() {
		...
		// 设置模块的名字，比如 core，生成效果为 com.wurui.core
